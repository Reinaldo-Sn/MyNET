...
from .views import PostListCreateView, PostDetailView, LikeToggleView, PostLikersView, PostRepostersView, RepostToggleView, CommentListCreateView, CommentDeleteView, CommentLikeToggleView, FeedView, PostSummaryView
...
urlpatterns = [
    ...
    path('<int:pk>/summary/', PostSummaryView.as_view(), name='post-summary'),
]
